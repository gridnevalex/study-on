...
class RegistrationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('password', PasswordType::class, array('constraints' => [new Length(['min' => 6,'minMessage' => 'Your password should be at least 6 symbols','max' => 4096,])], "error_bubbling" => true, 'label' => 'Пароль*', 'required' => true,  'attr' => array('class' => 'form-control form-control-lg')))
